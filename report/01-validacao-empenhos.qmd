...
A [API do Portal da Transparência possui um endpoint](https://api.portaldatransparencia.gov.br/swagger-ui.html#/Despesas%20P%C3%BAblicas/consultaHistoricoUsingGET) para consulta de **histórico dos itens empenhados**. Esse histórico só pode ser consultado para empenhos a partir de 2021 e um dos campos é `fase_operacao`, onde podemos saber se o item empenhado diz respeito à inclusão, reforço ou anulação do item.
